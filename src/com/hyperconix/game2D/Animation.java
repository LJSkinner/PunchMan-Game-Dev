...
public class Animation
{
     ...
     * @param reverse choose whether to reverse the order of the images
     */
    public void loadAnimationFromSheet(String fileName, int columns, int rows, int frameDuration, boolean reverse)
    {
        ...
        if(reverse)
        {
        	ArrayList<Image> tempList = new ArrayList<>( Arrays.asList(images)); 
        	
        	Collections.reverse(tempList);
        	
        	images = tempList.toArray(new Image[0]);
        }
     ...
     *
     * @param sheet   The sprite sheet to be used
     * @param columns The columns to be used
     * @param rows    The rows to be used
     *
     * @return split An array of images from the sprite sheet
     */
